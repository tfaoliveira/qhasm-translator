...
stack64 counter
enter crypto_stream_salsa2012_amd64_xmm6
...
out -= bytes
goto start
enter crypto_stream_salsa2012_amd64_xmm6_xor
r11_stack = r11_caller
r12_stack = r12_caller
r13_stack = r13_caller
r14_stack = r14_caller
...
uint32323232 diag0 += x0
uint32323232 diag1 += x1
uint32323232 diag2 += x2
uint32323232 diag3 += x3
in0 = diag0
in12 = diag1
in8 = diag2
in4 = diag3
