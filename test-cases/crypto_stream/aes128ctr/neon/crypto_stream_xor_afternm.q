...
tmp = tmp[3]tmp[2]tmp[1]tmp[0]
mem32[np+12] = tmp
in0 = mem128[input_1];input_1 += 16
in1 = mem128[input_1];input_1 += 16
in2 = mem128[input_1];input_1 += 16
in3 = mem128[input_1];input_1 += 16
  bb8 ^= in0
in4 = mem128[input_1];input_1 += 16
  bb9 ^= in1
in5 = mem128[input_1];input_1 += 16
  bb12 ^= in2
in6 = mem128[input_1];input_1 += 16
  bb14 ^= in3
in7 = mem128[input_1];input_1 += 16
  bb11 ^= in4
