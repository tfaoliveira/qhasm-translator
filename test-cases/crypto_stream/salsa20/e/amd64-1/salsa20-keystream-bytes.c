...
void
ECRYPT_keystream_bytes(uint64_t * arg1, void *arg2, uint64_t arg3, void *arg4)
{
    uint64_t        A;
    uint64_t        B;
    uint64_t        C;
  ...
  bytesatleast1:
    ...
    out0 ^= in0;                // out0 ^= in0
    out0 ^= *(uint64_t *) (m + 0);
    *(uint64_t *) (out + 0) = out0; // *(uint64 *) (out + 0) = out0
    in2 = j2;                   // in2 = j2
    out2 = in2;                 // out2 = in2
    ...
    out2 ^= in2;                // out2 ^= in2
    out2 ^= *(uint64_t *) (m + 8);
    *(uint64_t *) (out + 8) = out2; // *(uint64 *) (out + 8) = out2
    in4 = j4;                   // in4 = j4
    out4 = in4;                 // out4 = in4
    ...
    out4 ^= in4;                // out4 ^= in4
    out4 ^= *(uint64_t *) (m + 16);
    *(uint64_t *) (out + 16) = out4; // *(uint64 *) (out + 16) = out4
    in6 = j6;                   // in6 = j6
    out6 = in6;                 // out6 = in6
    ...
    out6 ^= in6;                // out6 ^= in6
    out6 ^= *(uint64_t *) (m + 24);
    *(uint64_t *) (out + 24) = out6; // *(uint64 *) (out + 24) = out6
    in8 = j8;                   // in8 = j8
    out8 = in8;                 // out8 = in8
    ...
    out8 ^= in8;                // out8 ^= in8
    out8 ^= *(uint64_t *) (m + 32);
    *(uint64_t *) (out + 32) = out8; // *(uint64 *) (out + 32) = out8
    in10 = j10;                 // in10 = j10
    ...
    out10 ^= in10;              // out10 ^= in10
    out10 ^= *(uint64_t *) (m + 40);
    *(uint64_t *) (out + 40) = out10; // *(uint64 *) (out + 40) = out10
    in12 = j12;                 // in12 = j12
    ...
    out12 ^= in12;              // out12 ^= in12
    out12 ^= *(uint64_t *) (m + 48);
    *(uint64_t *) (out + 48) = out12; // *(uint64 *) (out + 48) = out12
    in14 = j14;                 // in14 = j14
    ...
    out14 ^= in14;              // out14 ^= in14
    out14 ^= *(uint64_t *) (m + 56);
    *(uint64_t *) (out + 56) = out14; // *(uint64 *) (out + 56) = out14
