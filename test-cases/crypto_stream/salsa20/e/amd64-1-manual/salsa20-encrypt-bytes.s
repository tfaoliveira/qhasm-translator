...
# qhasm: out = arg3
# asm 1: mov  <arg3=int64#3,>out=int64#3
# asm 2: mov  <arg3=%rdx,>out=%rdx
mov  %rdx,%rdx

# qhasm: bytes = arg4
# asm 1: mov  <arg4=int64#4,>bytes=int64#5
# asm 2: mov  <arg4=%rcx,>bytes=%r8
mov  %rcx,%r8

# qhasm:               unsigned>? bytes - 0
# asm 1: cmp  $0,<bytes=int64#5
# asm 2: cmp  $0,<bytes=%r8
cmp  $0,%r8
...
# asm 1: movq   0(<x=int64#1),>in0=int64#4
# asm 2: movq   0(<x=%rdi),>in0=%rcx
movq   0(%rdi),%rcx

# qhasm: in2 = *(uint64 *) (x + 8)
# asm 1: movq   8(<x=int64#1),>in2=int64#6
# asm 2: movq   8(<x=%rdi),>in2=%r9
movq   8(%rdi),%r9

# qhasm: in4 = *(uint64 *) (x + 16)
# asm 1: movq   16(<x=int64#1),>in4=int64#7
# asm 2: movq   16(<x=%rdi),>in4=%rax
movq   16(%rdi),%rax

# qhasm: in6 = *(uint64 *) (x + 24)
# asm 1: movq   24(<x=int64#1),>in6=int64#8
# asm 2: movq   24(<x=%rdi),>in6=%r10
movq   24(%rdi),%r10

# qhasm: in8 = *(uint64 *) (x + 32)
# asm 1: movq   32(<x=int64#1),>in8=int64#9
# asm 2: movq   32(<x=%rdi),>in8=%r11
movq   32(%rdi),%r11

# qhasm: in10 = *(uint64 *) (x + 40)
# asm 1: movq   40(<x=int64#1),>in10=int64#10
# asm 2: movq   40(<x=%rdi),>in10=%r12
movq   40(%rdi),%r12

# qhasm: in12 = *(uint64 *) (x + 48)
# asm 1: movq   48(<x=int64#1),>in12=int64#11
# asm 2: movq   48(<x=%rdi),>in12=%r13
movq   48(%rdi),%r13

# qhasm: in14 = *(uint64 *) (x + 56)
# asm 1: movq   56(<x=int64#1),>in14=int64#12
# asm 2: movq   56(<x=%rdi),>in14=%r14
movq   56(%rdi),%r14
...
# qhasm: x_backup = x
# asm 1: movq <x=int64#1,>x_backup=stack64#16
# asm 2: movq <x=%rdi,>x_backup=120(%rsp)
movq %rdi,120(%rsp)
...
# asm 1: cmp  $64,<bytes=int64#5
# asm 2: cmp  $64,<bytes=%r8
cmp  $64,%r8
# comment:fp stack unchanged by jump
...
# qhasm:     ctarget = out
# asm 1: mov  <out=int64#3,>ctarget=int64#6
# asm 2: mov  <out=%rdx,>ctarget=%r9
mov  %rdx,%r9
...
# qhasm:     i = bytes
# asm 1: mov  <bytes=int64#5,>i=int64#4
# asm 2: mov  <bytes=%r8,>i=%rcx
mov  %r8,%rcx
...
# qhasm:     out = &tmp
# asm 1: leaq <tmp=stack512#1,>out=int64#3
# asm 2: leaq <tmp=288(%rsp),>out=%rdx
leaq 288(%rsp),%rdx
...
# asm 1: movq <out=int64#3,>out_backup=stack64#17
# asm 2: movq <out=%rdx,>out_backup=128(%rsp)
movq %rdx,128(%rsp)
...
# asm 1: movq <bytes=int64#5,>bytes_backup=stack64#19
# asm 2: movq <bytes=%r8,>bytes_backup=144(%rsp)
movq %r8,144(%rsp)
...
# qhasm:   in8 = j8
# asm 1: movq <j8=stack64#12,>in8=int64#5
# asm 2: movq <j8=88(%rsp),>in8=%r8
movq 88(%rsp),%r8
...
# qhasm:   x8 = in8
# asm 1: movq <in8=int64#5,>x8=stack64#24
# asm 2: movq <in8=%r8,>x8=184(%rsp)
movq %r8,184(%rsp)
...
# qhasm:   x9 = in8
# asm 1: movq <in8=int64#5,>x9=stack64#32
# asm 2: movq <in8=%r8,>x9=248(%rsp)
movq %r8,248(%rsp)
...
# qhasm: e = a + b
# asm 1: lea  (<a=int64#2,<b=int64#3),>e=int64#5
# asm 2: lea  (<a=%rsi,<b=%rdx),>e=%r8
lea  (%rsi,%rdx),%r8

# qhasm: (uint32) e <<<= 7
# asm 1: rol  $7,<e=int64#5d
# asm 2: rol  $7,<e=%r8d
rol  $7,%r8d

# qhasm: c ^= e
# asm 1: xor  <e=int64#5,<c=int64#4
# asm 2: xor  <e=%r8,<c=%rcx
xor  %r8,%rcx
...
# qhasm: d = x8
# asm 1: movq <x8=stack64#24,>d=int64#5
# asm 2: movq <x8=184(%rsp),>d=%r8
movq 184(%rsp),%r8
...
# qhasm: d ^= e
# asm 1: xor  <e=int64#7,<d=int64#5
# asm 2: xor  <e=%rax,<d=%r8
xor  %rax,%r8

# qhasm: x8 = d
# asm 1: movq <d=int64#5,>x8=stack64#24
# asm 2: movq <d=%r8,>x8=184(%rsp)
movq %r8,184(%rsp)

# qhasm: c += d
# asm 1: add  <d=int64#5,<c=int64#4
# asm 2: add  <d=%r8,<c=%rcx
add  %r8,%rcx
...
# qhasm: a += d
# asm 1: add  <d=int64#5,<a=int64#2
# asm 2: add  <d=%r8,<a=%rsi
add  %r8,%rsi
...
# qhasm: 		v = r + s
# asm 1: lea  (<r=int64#2,<s=int64#3),>v=int64#5
# asm 2: lea  (<r=%rsi,<s=%rdx),>v=%r8
lea  (%rsi,%rdx),%r8

# qhasm: 		(uint32) v <<<= 7
# asm 1: rol  $7,<v=int64#5d
# asm 2: rol  $7,<v=%r8d
rol  $7,%r8d

# qhasm: 		t ^= v
# asm 1: xor  <v=int64#5,<t=int64#4
# asm 2: xor  <v=%r8,<t=%rcx
xor  %r8,%rcx
...
# qhasm: 		u = x13
# asm 1: movq <x13=stack64#34,>u=int64#5
# asm 2: movq <x13=264(%rsp),>u=%r8
movq 264(%rsp),%r8
...
# qhasm: 		u ^= v
# asm 1: xor  <v=int64#7,<u=int64#5
# asm 2: xor  <v=%rax,<u=%r8
xor  %rax,%r8

# qhasm: 		x13 = u
# asm 1: movq <u=int64#5,>x13=stack64#34
# asm 2: movq <u=%r8,>x13=264(%rsp)
movq %r8,264(%rsp)

# qhasm: 		t += u
# asm 1: add  <u=int64#5,<t=int64#4
# asm 2: add  <u=%r8,<t=%rcx
add  %r8,%rcx
...
# qhasm: 		r += u
# asm 1: add  <u=int64#5,<r=int64#2
# asm 2: add  <u=%r8,<r=%rsi
add  %r8,%rsi
...
# qhasm: 				D = x2
# asm 1: movq <x2=stack64#21,>D=int64#5
# asm 2: movq <x2=160(%rsp),>D=%r8
movq 160(%rsp),%r8
...
# qhasm: 				x2 = D
# asm 1: movq <D=int64#5,>x2=stack64#21
# asm 2: movq <D=%r8,>x2=160(%rsp)
movq %r8,160(%rsp)
...
# qhasm: 						U = x7
# asm 1: movq <x7=stack64#31,>U=int64#5
# asm 2: movq <x7=240(%rsp),>U=%r8
movq 240(%rsp),%r8
...
# qhasm: 						x7 = U
# asm 1: movq <U=int64#5,>x7=stack64#31
# asm 2: movq <U=%r8,>x7=240(%rsp)
movq %r8,240(%rsp)
...
# asm 1: movq <out_backup=stack64#17,>out=int64#3
# asm 2: movq <out_backup=128(%rsp),>out=%rdx
movq 128(%rsp),%rdx
...
# qhasm:   out0 = in0
# asm 1: mov  <in0=int64#1,>out0=int64#4
# asm 2: mov  <in0=%rdi,>out0=%rcx
mov  %rdi,%rcx
...
# qhasm:   (uint32) in0 += x0
# asm 1: addl <x0=stack64#20,<in0=int64#1d
# asm 2: addl <x0=152(%rsp),<in0=%edi
addl 152(%rsp),%edi
...
# qhasm:   out0 ^= in0
# asm 1: xor  <in0=int64#1,<out0=int64#4
# asm 2: xor  <in0=%rdi,<out0=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out0=int64#4,0(<out=int64#3)
# asm 2: movq   <out0=%rcx,0(<out=%rdx)
movq   %rcx,0(%rdx)

# qhasm:   in2 = j2
# asm 1: movq <j2=stack64#9,>in2=int64#1
# asm 2: movq <j2=64(%rsp),>in2=%rdi
movq 64(%rsp),%rdi

# qhasm:   out2 = in2
# asm 1: mov  <in2=int64#1,>out2=int64#4
# asm 2: mov  <in2=%rdi,>out2=%rcx
mov  %rdi,%rcx
...
# qhasm:   (uint32) in2 += x2
# asm 1: addl <x2=stack64#21,<in2=int64#1d
# asm 2: addl <x2=160(%rsp),<in2=%edi
addl 160(%rsp),%edi
...
# qhasm:   out2 ^= in2
# asm 1: xor  <in2=int64#1,<out2=int64#4
# asm 2: xor  <in2=%rdi,<out2=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out2=int64#4,8(<out=int64#3)
# asm 2: movq   <out2=%rcx,8(<out=%rdx)
movq   %rcx,8(%rdx)

# qhasm:   in4 = j4
# asm 1: movq <j4=stack64#10,>in4=int64#1
# asm 2: movq <j4=72(%rsp),>in4=%rdi
movq 72(%rsp),%rdi

# qhasm:   out4 = in4
# asm 1: mov  <in4=int64#1,>out4=int64#4
# asm 2: mov  <in4=%rdi,>out4=%rcx
mov  %rdi,%rcx
...
# qhasm:   (uint32) in4 += x4
# asm 1: addl <x4=stack64#22,<in4=int64#1d
# asm 2: addl <x4=168(%rsp),<in4=%edi
addl 168(%rsp),%edi
...
# qhasm:   out4 ^= in4
# asm 1: xor  <in4=int64#1,<out4=int64#4
# asm 2: xor  <in4=%rdi,<out4=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out4=int64#4,16(<out=int64#3)
# asm 2: movq   <out4=%rcx,16(<out=%rdx)
movq   %rcx,16(%rdx)

# qhasm:   in6 = j6
# asm 1: movq <j6=stack64#11,>in6=int64#1
# asm 2: movq <j6=80(%rsp),>in6=%rdi
movq 80(%rsp),%rdi

# qhasm:   out6 = in6
# asm 1: mov  <in6=int64#1,>out6=int64#4
# asm 2: mov  <in6=%rdi,>out6=%rcx
mov  %rdi,%rcx
...
# qhasm:   (uint32) in6 += x6
# asm 1: addl <x6=stack64#23,<in6=int64#1d
# asm 2: addl <x6=176(%rsp),<in6=%edi
addl 176(%rsp),%edi
...
# qhasm:   out6 ^= in6
# asm 1: xor  <in6=int64#1,<out6=int64#4
# asm 2: xor  <in6=%rdi,<out6=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out6=int64#4,24(<out=int64#3)
# asm 2: movq   <out6=%rcx,24(<out=%rdx)
movq   %rcx,24(%rdx)
...
# qhasm:   out8 = in8
# asm 1: mov  <in8=int64#1,>out8=int64#4
# asm 2: mov  <in8=%rdi,>out8=%rcx
mov  %rdi,%rcx
...
# qhasm:   (uint32) in8 += x8
# asm 1: addl <x8=stack64#24,<in8=int64#1d
# asm 2: addl <x8=184(%rsp),<in8=%edi
addl 184(%rsp),%edi
...
# qhasm:   out8 ^= in8
# asm 1: xor  <in8=int64#1,<out8=int64#4
# asm 2: xor  <in8=%rdi,<out8=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out8=int64#4,32(<out=int64#3)
# asm 2: movq   <out8=%rcx,32(<out=%rdx)
movq   %rcx,32(%rdx)

# qhasm:   in10 = j10
# asm 1: movq <j10=stack64#13,>in10=int64#1
# asm 2: movq <j10=96(%rsp),>in10=%rdi
movq 96(%rsp),%rdi

# qhasm:   out10 = in10
# asm 1: mov  <in10=int64#1,>out10=int64#4
# asm 2: mov  <in10=%rdi,>out10=%rcx
mov  %rdi,%rcx
...
# asm 1: addl <x10=stack64#25,<in10=int64#1d
# asm 2: addl <x10=192(%rsp),<in10=%edi
addl 192(%rsp),%edi
...
# qhasm:   out10 ^= in10
# asm 1: xor  <in10=int64#1,<out10=int64#4
# asm 2: xor  <in10=%rdi,<out10=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out10=int64#4,40(<out=int64#3)
# asm 2: movq   <out10=%rcx,40(<out=%rdx)
movq   %rcx,40(%rdx)

# qhasm:   in12 = j12
# asm 1: movq <j12=stack64#14,>in12=int64#1
# asm 2: movq <j12=104(%rsp),>in12=%rdi
movq 104(%rsp),%rdi

# qhasm:   out12 = in12
# asm 1: mov  <in12=int64#1,>out12=int64#4
# asm 2: mov  <in12=%rdi,>out12=%rcx
mov  %rdi,%rcx
...
# asm 1: addl <x12=stack64#26,<in12=int64#1d
# asm 2: addl <x12=200(%rsp),<in12=%edi
addl 200(%rsp),%edi
...
# qhasm:   out12 ^= in12
# asm 1: xor  <in12=int64#1,<out12=int64#4
# asm 2: xor  <in12=%rdi,<out12=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out12=int64#4,48(<out=int64#3)
# asm 2: movq   <out12=%rcx,48(<out=%rdx)
movq   %rcx,48(%rdx)

# qhasm:   in14 = j14
# asm 1: movq <j14=stack64#15,>in14=int64#1
# asm 2: movq <j14=112(%rsp),>in14=%rdi
movq 112(%rsp),%rdi

# qhasm:   out14 = in14
# asm 1: mov  <in14=int64#1,>out14=int64#4
# asm 2: mov  <in14=%rdi,>out14=%rcx
mov  %rdi,%rcx
...
# asm 1: addl <x14=stack64#27,<in14=int64#1d
# asm 2: addl <x14=208(%rsp),<in14=%edi
addl 208(%rsp),%edi
...
# qhasm:   out14 ^= in14
# asm 1: xor  <in14=int64#1,<out14=int64#4
# asm 2: xor  <in14=%rdi,<out14=%rcx
xor  %rdi,%rcx
...
# asm 1: movq   <out14=int64#4,56(<out=int64#3)
# asm 2: movq   <out14=%rcx,56(<out=%rdx)
movq   %rcx,56(%rdx)

# qhasm:   bytes = bytes_backup
# asm 1: movq <bytes_backup=stack64#19,>bytes=int64#5
# asm 2: movq <bytes_backup=144(%rsp),>bytes=%r8
movq 144(%rsp),%r8
...
# qhasm:   in8 += 1
# asm 1: add  $1,<in8=int64#1
# asm 2: add  $1,<in8=%rdi
add  $1,%rdi

# qhasm:   j8 = in8
# asm 1: movq <in8=int64#1,>j8=stack64#12
# asm 2: movq <in8=%rdi,>j8=88(%rsp)
movq %rdi,88(%rsp)
...
# qhasm:       m = out
# asm 1: mov  <out=int64#3,>m=int64#2
# asm 2: mov  <out=%rdx,>m=%rsi
mov  %rdx,%rsi
...
# qhasm:   bytes -= 64
# asm 1: sub  $64,<bytes=int64#5
# asm 2: sub  $64,<bytes=%r8
sub  $64,%r8

# qhasm:   out += 64
# asm 1: add  $64,<out=int64#3
# asm 2: add  $64,<out=%rdx
add  $64,%rdx
