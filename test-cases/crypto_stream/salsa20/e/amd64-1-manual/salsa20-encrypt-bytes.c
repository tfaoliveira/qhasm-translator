...
void ECRYPT_encrypt_bytes(uint64_t *arg1, uint64_t *arg2, uint64_t *arg3, uint64_t arg4){
	 uint64_t A;
	 uint64_t B;
	 uint64_t C;
	 uint64_t D;
	...
	out0 <<= 32;//out0 <<= 32
	out0 ^= in0;//out0 ^= in0
	out0 ^= m[0];//out0 ^= *(uint64 *) (m + 0)
	out[0] = out0;//*(uint64 *) (out + 0) = out0
	in2 = j2;//in2 = j2
	out2 = in2;//out2 = in2
	out2 >>= 32;//out2 >>= 32
	...
	out2 <<= 32;//out2 <<= 32
	out2 ^= in2;//out2 ^= in2
	out2 ^= m[1];//out2 ^= *(uint64 *) (m + 8)
	out[1] = out2;//*(uint64 *) (out + 8) = out2
	in4 = j4;//in4 = j4
	out4 = in4;//out4 = in4
	out4 >>= 32;//out4 >>= 32
	...
	out4 <<= 32;//out4 <<= 32
	out4 ^= in4;//out4 ^= in4
	out4 ^= m[2];//out4 ^= *(uint64 *) (m + 16)
	out[2] = out4;//*(uint64 *) (out + 16) = out4
	in6 = j6;//in6 = j6
	out6 = in6;//out6 = in6
	out6 >>= 32;//out6 >>= 32
	...
	out6 <<= 32;//out6 <<= 32
	out6 ^= in6;//out6 ^= in6
	out6 ^= m[3];//out6 ^= *(uint64 *) (m + 24)
	out[3] = out6;//*(uint64 *) (out + 24) = out6
	in8 = j8;//in8 = j8
	out8 = in8;//out8 = in8
	out8 >>= 32;//out8 >>= 32
	...
	out8 <<= 32;//out8 <<= 32
	out8 ^= in8;//out8 ^= in8
	out8 ^= m[4];//out8 ^= *(uint64 *) (m + 32)
	out[4] = out8;//*(uint64 *) (out + 32) = out8
	in10 = j10;//in10 = j10
	...
	out10 <<= 32;//out10 <<= 32
	out10 ^= in10;//out10 ^= in10
	out10 ^= m[5];//out10 ^= *(uint64 *) (m + 40)
	out[5] = out10;//*(uint64 *) (out + 40) = out10
	in12 = j12;//in12 = j12
	...
	out12 <<= 32;//out12 <<= 32
	out12 ^= in12;//out12 ^= in12
	out12 ^= m[6];//out12 ^= *(uint64 *) (m + 48)
	out[6] = out12;//*(uint64 *) (out + 48) = out12
	in14 = j14;//in14 = j14
	...
	out14 <<= 32;//out14 <<= 32
	out14 ^= in14;//out14 ^= in14
	out14 ^= m[7];//out14 ^= *(uint64 *) (m + 56)
	out[7] = out14;//*(uint64 *) (out + 56) = out14
