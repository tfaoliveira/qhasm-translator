...
k2k3k6k7 = k2k3k6k7[0] k4k5k6k7[1]
  ...
  start1 = start1[0,1] start1[1] k4k5k6k7[0] 
						  assign r4 r5 to j12 j13; j1213_stack = j12 j13
						j1 = mem32[k + 0]
4x n2n3n3n2 unsigned>>= 7
						j4 = mem32[k + 12]
  k1n1k7k2 = k1n1k7k2[0,1] k4k5k6k7[3] k0k1k2k3[2] 
						j11 = mem32[k + 16]
  k1n1k7k2 = k0k1k2k3[1] start1[0] k1n1k7k2[2,3]   
						j14 = mem32[k + 28]
  start1 = k4k5k6k7[1] k0k1k2k3[0] start1[2,3]     
						j0 = mem32[i + 0]
blockshift = n2n3n3n2
						j5 = mem32[i + 4]
  int32 ptr_k2k3k6k7
...
assign r11 to x11
  ...
  assign r0 r1 to j8 j9 = j89_stack
				  new t12
				  t12 = t12[0,1] v0[3] v4[2]       
  assign r2 r3 to x12 x13 = x1213_stack
				  v0 = (abab & v0) | (~abab & v12) 
  assign r4 r5 to j12 j13 = j1213_stack
				  t4 = t4[0,1] v8[3] v12[2]        
  x8 += j8
				  t12 = v8[1] v12[0] t12[2,3]      
  x9 += j9
				  v8 = (abab & v8) | (~abab & v4)  
  x12 += j12
				  v4 = t4[1]t4[0]t4[3]t4[2]        
  x13 += j13
				  v12 = t12[1]t12[0]t12[3]t12[2]   
  carry? j8 += 3
				  v0 v8 = v0[0] v8[1] v8[0] v0[1]  
  j9 += 0 + carry
  assign r0 r1 to j8 j9; j89_stack = j8 j9
  ...
  mem32[c - 92] = x9
				  ptr_start2 = &next_start2
  mem32[c - 88] = x10
				  4x v0 = next_diag0 + start0      
				  v4 aligned= mem128[ptr_start3]
				  4x v4 += next_diag3              
				  v8 aligned= mem128[ptr_start2]
				  4x v12 = next_diag1 + start1     
				  4x v8 += next_diag2              
  mem32[c - 84] = x11
				  new t4
				  t4 = v0[1] v4[0] t4[2,3]         
