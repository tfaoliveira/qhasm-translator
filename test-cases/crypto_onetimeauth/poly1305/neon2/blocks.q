...
input_2 += 32
mainloop2:
  c01 = mem128[input_2];input_2+=16 
  c23 = mem128[input_2];input_2+=16 
...
r3[0,1] +=  x4[0] unsigned*  5z34[2]; r3[2,3] +=  x4[1] unsigned*  5z34[3]
  r0 = r0[1]r0[0]r0[3]r0[2] 
  r2[0,1] = c01[2]<<12; r2[2,3] = c01[3]<<12 
  		d01 = mem128[input_2];input_2+=16 
...
r2[0,1] +=  x4[0] unsigned* 5z34[0]; r2[2,3] +=  x4[1] unsigned* 5z34[1]
  r0 = r0[0,1]c01[1]r0[2] 
  r1[0,1] = c23[0]<<6; r1[2,3] = c23[1]<<6 
...
r0[0,1] += x23[2] unsigned* 5y12[2]; r0[2,3] += x23[3] unsigned* 5y12[3]
  c01 c23 = c01[0]c23[0]c01[2]c23[2]c01[1]c23[1]c01[3]c23[3] 
