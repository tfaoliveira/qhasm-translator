...
int64 bufp
int64 offset
enter hash_2n_n_8x_notrans
rotate8 = mem256[_rotate8]
rotate16 = mem256[_rotate16]
constp = &hashc8x
bufp = &buf
x0  = mem256[input_1 +   0]
x1  = mem256[input_1 +  32]
x2  = mem256[input_1 +  64]
x3  = mem256[input_1 +  96]
x4  = mem256[input_1 + 128]
x5  = mem256[input_1 + 160]
x6  = mem256[input_1 + 192]
x7  = mem256[input_1 + 224]
input_1 += 32
x6stack = x6
x8  = mem256[constp +   0]
x9  = mem256[constp +  32]
