...
enter crypto_sign_ed25519_amd64_51_30k_batch_heap_rootreplaced
...
carry? c1 -= *(uint64 *)(sprc +  8) - carry
carry? c2 -= *(uint64 *)(sprc + 16) - carry
carry? c3 -= *(uint64 *)(sprc + 24) - carry
pc = prc if carry
spc = sprc if carry
spc -= sp
(uint64) spc >>= 5
...
carry? c1 -= *(uint64 *)(spp +  8) - carry
carry? c2 -= *(uint64 *)(spp + 16) - carry
carry? c3 -= *(uint64 *)(spp + 24) - carry
goto end if carry
spc -= sp
(uint64) spc >>= 5
spp -= sp
