...
enter crypto_sign_ed25519_amd64_51_30k_batch_ge25519_add_p1p1
...
t14 = *(uint64 *)(qp + 72)
t20 = t10
t10 += *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_2P0
rx0 = *(uint64 *) (qp + 0)
t20 += rx0
t10 -= rx0
t21 = t11
t11 += *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_2P1234
rx1 = *(uint64 *) (qp + 8)
t21 += rx1
t11 -= rx1
t22 = t12
t12 += *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_2P1234
rx2 = *(uint64 *) (qp + 16)
t22 += rx2
t12 -= rx2
t23 = t13
t13 += *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_2P1234
rx3 = *(uint64 *) (qp + 24)
t23 += rx3
t13 -= rx3
t24 = t14
t14 += *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_2P1234
rx4 = *(uint64 *) (qp + 32)
t24 += rx4
t14 -= rx4
t10_stack = t10
