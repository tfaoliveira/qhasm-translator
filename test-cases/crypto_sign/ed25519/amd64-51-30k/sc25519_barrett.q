...
stack64 q32_stack
stack64 q33_stack
enter crypto_sign_ed25519_amd64_51_30k_batch_sc25519_barrett
...
q33 ^= q33
rax = *(uint64 *)(xp + 24)
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_MU3
q23 = rax
c = rdx
rax = *(uint64 *)(xp + 24)
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_MU4
q24 = rax
carry? q24 += c
q30 += rdx + carry
rax = *(uint64 *)(xp + 32)
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_MU2
carry? q23 += rax
c = 0
c += rdx + carry
rax = *(uint64 *)(xp + 32)
...
q31 += rdx + carry
rax = *(uint64 *)(xp + 40)
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_MU1
carry? q23 += rax
c = 0
c += rdx + carry
rax = *(uint64 *)(xp + 40)
...
q32 += rdx + carry
rax = *(uint64 *)(xp + 48)
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_MU0
carry? q23 += rax
c = 0
c += rdx + carry
rax = *(uint64 *)(xp + 48)
...
q33_stack = q33
rax = q30_stack
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_ORDER0
r20 = rax
c = rdx
rax = q30_stack
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_ORDER1
r21 = rax
carry? r21 += c
c = 0
c += rdx + carry
rax = q30_stack
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_ORDER2
r22 = rax
carry? r22 += c
c = 0
c += rdx + carry
rax = q30_stack
(uint128) rdx rax = rax * *(uint64 *) &crypto_sign_ed25519_amd64_51_30k_batch_ORDER3
free rdx
r23 = rax
r23 += c
rax = q31_stack
