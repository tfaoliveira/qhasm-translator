...
4x b1 = sum1 + dif1									
	suma1 difa1 = suma1[0]difa1[0]suma1[2]difa1[2] suma1[1]difa1[1]suma1[3]difa1[3]	
4x b4 = sum1 - dif1									
	4x suma0 = a0 + a3
...
a2 suma1 = a2[0]suma1[0] a2[1]suma1[1]	
4x a3 = a3 + _29_28
...
q3 &= mask25
2x q5 += t2
q2 q3 = q2[0]q3[0]q2[2]q3[2] q2[1]q3[1]q2[3]q3[3]	
p4 q5 = p4[0]q5[0]p4[2]q5[2] p4[1]q5[1]p4[3]q5[3]
4x n1 = _28_27_28_27 - q2 
4x n2 = _27 - p4 
n0 = n0[0,2,1,3] 
n1 = n1[0,2,1,3] 
adr0 = input_0 + 48
q0 = n2[1,2,3]p4[0] 
4x sum1 = na1 + n1
mem128[adr0] = n0; adr0+=16	
p4 = q0[3]q0[0,1,2] 
4x dif1 = na1 - n1
mem128[adr0] = n1; adr0+=16	
p4 = p4[0,2,1,3] 
sum1 dif1 = sum1[0]dif1[0]sum1[2]dif1[2] sum1[1]dif1[1]sum1[3]dif1[3]
4x sum0 = na0 + n0
...
h1 &= mask25
adr0 = input_0 + 32			
mem128[adr0] aligned = h4; adr0+=16	
...
h1 &= mask25
mem128[adr1] aligned = k2; adr1+=16	
