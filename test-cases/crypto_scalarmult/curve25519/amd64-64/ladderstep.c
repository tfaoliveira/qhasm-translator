#include "qhasm-translator.h"
 ...
 /*CHECKME*/ extern uint64_t crypto_scalarmult_curve25519_amd64_64_38;
/*CHECKME*/ extern uint64_t crypto_scalarmult_curve25519_amd64_64_121666;
...
crypto_scalarmult_curve25519_amd64_64_ladderstep(uint64_t * workp)
{
    ...
    squarerax = squarer4;
    multiply128(squarerdx, squarerax, squarerax, (crypto_scalarmult_curve25519_amd64_64_38));
    squarer4 = squarerax;
    squarerax = squarer5;
    squarer5 = squarerdx;
    multiply128(squarerdx, squarerax, squarerax, (crypto_scalarmult_curve25519_amd64_64_38));
    ...
    mulx0 = t30_stack;
    mulrax = t20_stack;
    multiply128(mulrdx, mulrax, mulrax, mulx0);
    t90 = mulrax;
    t91 = mulrdx;
    mulrax = t21_stack;
    multiply128(mulrdx, mulrax, mulrax, mulx0);
    ...
    mulx1 = t31_stack;
    mulrax = t20_stack;
    multiply128(mulrdx, mulrax, mulrax, mulx1);
    add64_and_set_carry(t91, t91, mulrax); // cf? t91 += mulrax
    mulc = 0;
    ...
    mulx2 = t32_stack;
    mulrax = t20_stack;
    multiply128(mulrdx, mulrax, mulrax, mulx2);
    add64_and_set_carry(t92, t92, mulrax); // cf? t92 += mulrax
    mulc = 0;
    add64_with_carry(mulc, mulc, mulrdx); // mulc += mulrdx + cf; 
    mulrax = t21_stack;
    ...
    mulx3 = t33_stack;
    mulrax = t20_stack;
    multiply128(mulrdx, mulrax, mulrax, mulx3);
    add64_and_set_carry(t93, t93, mulrax); // cf? t93 += mulrax
    mulc = 0;
    add64_with_carry(mulc, mulc, mulrdx); // mulc += mulrdx + cf; 
    mulrax = t21_stack;
    ...
    mulrax = mulr4;
    multiply128(mulrdx, mulrax, mulrax, (crypto_scalarmult_curve25519_amd64_64_38));
    mulr4 = mulrax;
    mulrax = mulr5;
    mulr5 = mulrdx;
    multiply128(mulrdx, mulrax, mulrax, (crypto_scalarmult_curve25519_amd64_64_38));
    ...
    squarer7 = 0;
    squarerax = workp[13];
    multiply128(squarerdx, squarerax, squarerax, workp[12]); // squarerdx, squarerax = squarerax * workp[$p0];
    xq1 = squarerax;
    xq2 = squarerdx;
    squarerax = workp[14];
    multiply128(squarerdx, squarerax, squarerax, workp[13]); // squarerdx, squarerax = squarerax * workp[$p0];
    xq3 = squarerax;
    squarer4 = squarerdx;
    squarerax = workp[15];
    multiply128(squarerdx, squarerax, squarerax, workp[14]); // squarerdx, squarerax = squarerax * workp[$p0];
    squarer5 = squarerax;
    squarer6 = squarerdx;
    squarerax = workp[14];
    multiply128(squarerdx, squarerax, squarerax, workp[12]); // squarerdx, squarerax = squarerax * workp[$p0];
    ...
    multiply128(mul121666rdx, mul121666rax, mul121666rax, (crypto_scalarmult_curve25519_amd64_64_121666));
    zp0 = mul121666rax;
    zp1 = mul121666rdx;
