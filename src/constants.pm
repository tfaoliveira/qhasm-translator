...
######################################################################## DOC
use constant RX_TYPES => '(it|iv|int3232|int32|int64|reg128|int256|reg256|stack32|stack64|stack128|stack512|stack4864|ptr4864|float80)';
...
use constant RX_OPERAND => '(=|\+=|-=|\*=|/=|<<=|>>=|\|=|\^=|&=|aligned=)';
...
use constant RX_VART	 	=> "(stack32|stack64|stack128|stack512|stack4864|ptr4864|int3232|int32|int64|reg128|int256|reg256|float80)";
